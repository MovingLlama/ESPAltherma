...
LabelDef labelDefs[] = {
    ...
    {0x60, 11, 305, 1, -1,
     "Übertemperaturschutz Clixon Heizstab Speicher BSH (ON=OK)"},
    {0x60, 11, 304, 1, -1, "HT/NT Tarif Abschaltung"},
    {0x60, 11, 303, 1, -1, "Solar Eingang"},
    {0x60, 11, 302, 1, -1, "Smart-Grid-Kontakt 2"},
    {0x60, 11, 301, 1, -1, "Smart-Grid-Kontakt 1"},
    ...
    {0x62, 8, 336, 1, -1, "Pump Feedback (bit4)"},
    ...
    {0x63, 8, 105, 2, 1,
     "[HPSU] Mischwassertemperatur nach Speicher R7T (DLWA2)"},
    {0x63, 10, 101, 1, -1,
     "[HPSU] Speicherventil Position (0:Bypass 100:Speicher)"},
    {0x63, 11, 101, 1, -1,
     "[HPSU] Bypassventil Position (0:Bypass 100:Heizkörper)"},
    {0x63, 12, 323, 1, -1,
     "[HPSU] Speicherstatus (1:vorheizen 2:unterstützen 3:überschuss)"},
    {0x63, 12, 305, 1, -1, "[HPSU] Speicher DHW bivalentes Ausgangssignal"},
    {0x63, 12, 304, 1, -1,
     "[HPSU] Speicher DHW bivalente primäre Wärmequelle (OFF:WP ON:Kessel)"},
    {0x63, 12, 303, 1, -1, "[HPSU] Speicher Heizen bivalentes Ausgangssignal"},
    {0x63, 12, 302, 1, -1,
     "[HPSU] Speicher Heizen bivalente primäre Wärmequelle (OFF:WP ON:Kessel)"},
    {0x63, 12, 317, 1, -1,
     "Raumthermostat Kontrollstatus (0:thermo aus 1:thermo an 2:puffern)"},
    ...
    {0x65, 4, 105, 2, 1,
     "[EKMIK] Bizone kit Mischwasseraustrittstemperatur R1T"},
